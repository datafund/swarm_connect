...
from app.services.bandwidth_credit import bandwidth_credit_manager, parse_topup_mb
...
async def top_up_credit(
    request: Request,
    mb: str = Query(..., description="Amount of bandwidth credit to add, in MB (1 MB = 10^6 bytes)."),
) -> CreditTopUpResponse:
    """
